...
Guards: the wrong linear combination v_inf + v_esc, and the arithmetic-mean and mass-weighted-mean wrong orbits. Rock conservation, the retained-plus-lost atmosphere closure, the mass-into-fraction-array guard, mass-based survivor selection, and the [0, 1] clamp of the loss fraction are asserted alongside.
