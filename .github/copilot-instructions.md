...
Every unit test on a **physics source** (`driver.py`, `orbit_cross_K25.py`, `interaction_timescales.py`, `crossing_pair.py`, `merge_embryo.py`, `secular_solution.py`, `mass_loss.py`, `helper_functions.py`) must assert at least one of:
